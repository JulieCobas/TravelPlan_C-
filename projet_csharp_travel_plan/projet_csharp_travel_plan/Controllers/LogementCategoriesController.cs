...
namespace projet_csharp_travel_plan.Controllers
{
    ...
    [ApiController]
    public class LogementCategoriesController : ControllerBase
    {
        private readonly TravelPlanContext _context;

        public LogementCategoriesController(TravelPlanContext context)
        {
            _context = context;
        }

        // GET: api/LogementCategories
        [HttpGet]
        ...
        // DELETE: api/LogementCategories/5
        [HttpDelete("{id}")]
